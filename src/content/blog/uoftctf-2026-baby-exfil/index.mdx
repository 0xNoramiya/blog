...
date: 2026-01-12
tags: ['writeup', 'forensics', 'pcap', 'malware', 'python', 'uoftctf', '2026']
authors: ['kudaliar']
draft: false
---
...
decrypt_file(hex_blob_1, "recovered_1.jpg")
decrypt_file(hex_blob_2, "recovered_2.jpg")
decrypt_file(hex_blob_3, "recovered_3.jpg")
decrypt_file(hex_blob_4, "recovered_4.jpg")
decrypt_file(hex_blob_5, "recovered_5.jpg")
```
...
<img src={flagImage.src} alt="Recovered image containing the flag" style="max-width: 100%; border-radius: 8px; margin: 1rem 0;" />

*The recovered image with the flag embedded: `uoftctf{b4by_w1r3sh4rk_an4lys1s}`*
