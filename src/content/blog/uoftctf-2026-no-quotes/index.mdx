...
date: 2026-01-12
tags: ['writeup', 'web', 'sqli', 'ssti', 'waf-bypass', 'python', 'uoftctf', '2026']
authors: ['kudaliar']
draft: false
---
...
|-----------|------------|------|
| **No Quotes 1** | Easy | `uoftctf{w0w_y0u_5UcC355FU1Ly_Esc4p3d_7h3_57R1nG!}` |
| **No Quotes 2** | Easy | `uoftctf{d1d_y0u_wR173_4_pr0P3r_qU1n3_0r_u53_INFORMATION...}` |
| **No Quotes 3** | Medium | `uoftctf{r3cuR510n_7h30R3M_m0M3n7}` |
